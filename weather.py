...
def weather():
    ...
    # data for variable list_of_data
        ...
        data = {
            ...
            "icon1": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][2]['weather'][0]['icon'] + ".png")),
            ...
            "icon2": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][10]['weather'][0]['icon'] + ".png")),
            ...
            "icon3": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][14]['weather'][0]['icon'] + ".png")),
            ...
            "icon4": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][18]['weather'][0]['icon'] + ".png")),
            ...
            "icon5": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][22]['weather'][0]['icon'] + ".png")),
            ...
            "icon6": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][26]['weather'][0]['icon'] + ".png")),
            ...
            "icon7": ("https://openweathermap.org/img/wn/" + str(
...
def weather1():
    if response & response1 != 200:
        ...
        data = {
            ...
            "icon1": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][0]['weather'][0]['icon'] + ".png")),
            ...
            "icon2": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][3]['weather'][0]['icon'] + ".png")),
            ...
            "icon3": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][6]['weather'][0]['icon'] + ".png")),
            ...
            "icon4": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][9]['weather'][0]['icon'] + ".png")),
            ...
            "icon5": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][12]['weather'][0]['icon'] + ".png")),
            ...
            "icon6": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][15]['weather'][0]['icon'] + ".png")),
            ...
            "icon8": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][21]['weather'][0]['icon'] + ".png")),
            ...
            "icon9": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][24]['weather'][0]['icon'] + ".png")),
            ...
            "icon10": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][27]['weather'][0]['icon'] + ".png")),
            ...
            "icon11": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][30]['weather'][0]['icon'] + ".png")),
            ...
            "icon12": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][33]['weather'][0]['icon'] + ".png")),
            ...
            "icon13": ("https://openweathermap.org/img/wn/" + str(
                list_of_data['list'][36]['weather'][0]['icon'] + ".png")),
